          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl shadow-2xl p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 bg-gradient-to-r from-[var(--color-cta-from)] to-[var(--color-cta-to)] hover:from-[var(--color-cta-hover-from)] hover:to-[var(--color-cta-hover-to)] text-white py-4 rounded-2xl font-bold shadow-xl transition active:scale-[0.99]"
              >
